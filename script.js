...
function changeBackground(condition) {
  ...
  let bg = "";
  if (condition === "partly-cloudy-day") {
    bg = "https://i.ibb.co/GHHw3t1/partly-cloudy-day-bg.jpg";
  } else if (condition === "partly-cloudy-night") {
    bg = "https://i.ibb.co/QrV3KM4/partly-cloudy-night-bg.jpg";
  } else if (condition === "rain") {
    bg = "https://i.ibb.co/L663d3L/rainy-bg.jpg";
  } else if (condition === "clear-day") {
    bg = "https://i.ibb.co/f8NF7Jh/clear-day-bg.jpg";
  } else if (condition === "clear-night") {
    bg = "https://i.ibb.co/3BWbD8W/night-sky.jpg";
  } else {
    bg = "https://i.ibb.co/f8NF7Jh/clear-day-bg.jpg";
  }
